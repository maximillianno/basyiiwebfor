...
-- Дамп структуры базы данных yiishop
CREATE DATABASE IF NOT EXISTS `yiishop` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `yiishop`;

-- Дамп структуры для таблица yiishop.category
...
-- Дамп данных таблицы yiishop.category: ~30 rows (приблизительно)
...
INSERT INTO `category` (`id`, `parent_id`, `name`, `keywords`, `description`) VALUES
	...
	(32, 23, 'Sapog', NULL, NULL),
	(33, 32, 'Тестовая категория', 'тест', 'для теста');
/*!40000 ALTER TABLE `category` ENABLE KEYS */;

-- Дамп структуры для таблица yiishop.image
...
-- Дамп данных таблицы yiishop.image: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `image` DISABLE KEYS */;
/*!40000 ALTER TABLE `image` ENABLE KEYS */;

-- Дамп структуры для таблица yiishop.migration
...
-- Дамп данных таблицы yiishop.migration: ~3 rows (приблизительно)
/*!40000 ALTER TABLE `migration` DISABLE KEYS */;
INSERT INTO `migration` (`version`, `apply_time`) VALUES
	('m000000_000000_base', 1539687948),
	('m140622_111540_create_image_table', 1540711117),
	('m140622_111545_add_name_to_image_table', 1540711118);
/*!40000 ALTER TABLE `migration` ENABLE KEYS */;

-- Дамп структуры для таблица yiishop.order
...
-- Дамп данных таблицы yiishop.order: ~4 rows (приблизительно)
/*!40000 ALTER TABLE `order` DISABLE KEYS */;
INSERT INTO `order` (`id`, `created_at`, `updated_at`, `qty`, `sum`, `status`, `name`, `email`, `phone`, `address`) VALUES
	(1, '2018-10-15 17:19:38', '2018-10-15 17:19:38', 44, 660, '1', 'maxus', 'max.star@gmail.com', '1231231', 'sjkadf skjdfh'),
	(5, '2018-10-15 17:34:37', '2018-10-15 17:34:37', 44, 660, '0', 'maxus', 'max.star@gmail.com', '1231231', 'sjkadf skjdfh'),
	(6, '2018-10-16 08:15:09', '2018-10-16 08:15:09', 43, 909, '0', 'maxus1', 'maxus.star@gmail.com', '12312311', 'sjkadf skjdfh');
/*!40000 ALTER TABLE `order` ENABLE KEYS */;

-- Дамп структуры для таблица yiishop.order_items
...
-- Дамп данных таблицы yiishop.order_items: ~5 rows (приблизительно)
/*!40000 ALTER TABLE `order_items` DISABLE KEYS */;
INSERT INTO `order_items` (`id`, `order_id`, `product_id`, `name`, `price`, `qty_item`, `sum_item`) VALUES
	(1, 5, 10, 'Сумка GUSSACI TUGUS13A060-3-10', 15, 44, 660),
	(2, 6, 10, 'Сумка GUSSACI TUGUS13A060-3-10', 15, 39, 585),
	(3, 6, 1, 'Джинсы Garcia 244/32/856 28-32 р Серо-синие', 10, 2, 20),
	(4, 6, 12, 'Cумка Michael Kors Selma Золотистая', 205, 1, 205),
	(5, 6, 8, 'Брюки SK House 2211-1972кор L Коричневые', 99, 1, 99);
/*!40000 ALTER TABLE `order_items` ENABLE KEYS */;

-- Дамп структуры для таблица yiishop.product
...
-- Дамп данных таблицы yiishop.user: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `auth_key`) VALUES
	(1, 'maxus', '$2y$13$CpJphOCI1yWbx0kgB7ANAu2Ml2xacECJFlwY2Hue2BvdEWj.mtF4q', '1');
