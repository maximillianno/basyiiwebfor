...
//        $arr1 = [1,3, 'id' => 8];
//        $arr2 = [0,23,5, 'id' => 9];
//        $resAdd = ArrayHelper::merge($arr1, $arr2);
//        $resPlus = $arr1 + $arr2;
//        $resMerge = array_merge($arr1, $arr2);
//        dd($resPlus, $resMerge, $resAdd);
    ...
    {
        //Проверка работы map
//        $res5 =  \app\models\Category::find()->all();
//        $res1 = array_map(function($res){ return $res['name']; },\app\models\Category::find()->indexBy('id')->all());
